$(function () {
    ...
    $("#add-vendor").on("click", function (event) {
        $("#addVendorModal #btn-add").show();
        $("#addVendorModal #btn-edit").hide();
        $("#addVendorModal").modal("show");
    });

    $("#btn-add-fund").on("click", function (event) {
        $("#addFundModal #btn-add").show();
        $("#addFundModal #btn-edit").hide();
    ...
    function addContact() {
        $("#btn-add").click(function () {
            ...
            $html =
                ...
                '<a href="javascript:void(0)" class="text-dark ms-2"><i class="ti ti-trash fs-5"></i></a>' +
                "</div>" +
                "</td>" +
                "</tr>";
