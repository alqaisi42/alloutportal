            ...
            <div class="owl-carousel counter-carousel owl-theme">
                    ...
                    <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/Modernize/images/svgs/icon-user-male.svg" width="50" height="50" class="mb-3"
                                    alt="" />
                                <p class="fw-semibold fs-3 text-primary mb-1">Total Clients</p>
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/Modernize/images/svgs/icon-briefcase.svg" width="50" height="50" class="mb-3"
                                    alt="" />
                                <p class="fw-semibold fs-3 text-warning mb-1">Total Bookings</p>
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/Modernize/images/svgs/icon-mailbox.svg" width="50" height="50" class="mb-3"
                                    alt="" />
                                <p class="fw-semibold fs-3 text-info mb-1">Total Services</p>
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/Modernize/images/svgs/icon-favorites.svg" width="50" height="50" class="mb-3"
                                    alt="" />
                                <p class="fw-semibold fs-3 text-danger mb-1">Total Locations</p>
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/Modernize/images/svgs/icon-connect.svg" width="50" height="50" class="mb-3"
                                    alt="" />
                                <p class="fw-semibold fs-3 text-info mb-1">Total Categories</p>
                        ...
                        <div class="card-body">
                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                <div class="mb-3 mb-sm-0">
                                    <h5 class="card-title fw-semibold">Total Earnings</h5>
                                    <p class="card-subtitle mb-0">136.5 AED</p>
                                </div>
                                <select class="form-select w-auto">
                                    <option value="1">By Day</option>
                                    <option value="2">By Week</option>
                                    <option value="3">By Month</option>
                                    <option value="4">By 3 Months</option>
                                    <option value="4">By 6 Months</option>
                                    <option value="4">By 1 Year</option>
                                    <option value="4">By All Time</option>
                                </select>
                            </div>
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="hstack mb-4 pb-1">
                                        ...
                                        <div>
                                            <h4 class="mb-0 fs-7 fw-semibold">63,489.50 AED</h4>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-baseline mb-4">
                                            ...
                                            <div>
                                                ...
                                                <h6 class="fs-5 fw-semibold mb-0">48,820 AED</h6>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-baseline mb-4 pb-1">
                                            ...
                                            <div>
                                                ...
                                                <h6 class="fs-5 fw-semibold mb-0">26,498 AED</h6>
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            ...
                                            <h4 class="fw-semibold mb-3">148</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-7 pb-2">
                                <div class="me-3 pe-1">
                                    <img src="/Modernize/images/profile/user-1.jpg" class="shadow-warning rounded-2"
                                ...
                                <ul class="hstack mb-0">
                                    <li class="ms-n8">
                                        <a href="javascript:void(0)" class="me-1">
                                            <img src="/Modernize/images/profile/user-2.jpg"
                                    ...
                                    <li class="ms-n8">
                                        <a href="javascript:void(0)" class="me-1">
                                            <img src="/Modernize/images/profile/user-3.jpg"
                                                class="rounded-circle border border-2 border-white" width="44"
                                                height="44" alt="" />
                                        </a>
                                    </li>
                                    <li class="ms-n8">
                                        <a href="javascript:void(0)" class="me-1">
                                            <img src="/Modernize/images/profile/user-4.jpg"
                                                class="rounded-circle border border-2 border-white" width="44"
                                                height="44" alt="" />
                                        </a>
                                    </li>
                                    <li class="ms-n8">
                                        <a href="javascript:void(0)" class="me-1">
                                            <img src="/Modernize/images/profile/user-5.jpg"
                                                class="rounded-circle border border-2 border-white" width="44"
                                                height="44" alt="" />
                                        </a>
                                    </li>
