  ...
  <div class="body-wrapper">
    <div class="container-fluid">
      ...
      >
        <div class="card-body px-4 py-3">
          <div class="row align-items-center">
            <div class="col-9">
              <h4 class="fw-semibold mb-8">{{ $t("Split Payment") }}</h4>
      ...
      <form class="mt-4 row" novalidate="">
        ...
        <div class="mb-3 form-group col-3">
          ...
          <div class="controls">
            ...
            >
              <option value="">All</option>
              <option :value="item.id" v-for="item in bookings" :key="item.id">
                {{ item.id }}
              </option>
            </select>
            <div class="help-block"></div>
      ...
      <div class="card card-body" v-if="load">
        <h3>Split Payments List ({{ listing.content.length }})</h3>
...
export default {
  ...
  async mounted() {
    ...
    axios
      ...
      .then(
        axios.spread((invitations, customers, bookings) => {
