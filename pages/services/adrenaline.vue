  ...
  <div class="body-wrapper">
    <div class="container-fluid">
      ...
      >
        <div class="card-body px-4 py-3">
          <div class="row align-items-center">
            <div class="col-9">
              <h4 class="fw-semibold mb-8">{{ $t("Adrenaline Meter") }}</h4>
      ...
      <div class="card card-body">
        <h3>Adrenaline Meter's List ({{ listing.length }})</h3>
          ...
          >
            ...
            <tbody>
              <tr v-for="item in listing" :key="item.createdDate">
                ...
                <td>
                  <span
                    v-if="item.titleEn == 'Low Adrenaline'"
                    class="btn btn-sm badge-success"
                    >Low</span
                  >
                  <span
                    v-else-if="item.titleEn == 'Medium Adrenaline'"
                    class="btn btn-sm badge-warning"
                    >Medium</span
                  >
                  <span v-else class="btn btn-sm badge-danger">High</span>
                </td>
                <td>{{ item.descEn }}</td>
                <td>
                ...
                <td>{{ getBranche(item.branchId) }}</td>
                    ...
                    <div class="mb-3 form-group">
                      ...
                      <div class="controls">
                        <select
                          ...
                          aria-invalid="false"
                        >
                          <option value="">Set Branche</option>
      ...
      if (this.load)
        if (this.branches.length > 0) {
          for (let k in this.branches) {
            if (!this.branches.includes(k)) {
              let item = this.branches[k];
              if (item.id == id) {
                return item.nameEn;
              }
            }
      ...
      if (this.action == "insert") {
        ...
        axios
          ...
          .then((response) => {
            if (response.data.success == true) {
              this.$toast.success(response.data.messageText).goAway(1500);
              this.link = "/branch/adrenalineMeters";
              this.getAll();
              this.data = {
                titleAr: null,
                titleEn: null,
