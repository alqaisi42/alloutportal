  ...
  <div class="body-wrapper">
    <div class="container-fluid">
      ...
      >
        <div class="card-body px-4 py-3">
          <div class="row align-items-center">
            <div class="col-9">
              <h4 class="fw-semibold mb-8">{{ $t("Refund") }}</h4>
      ...
      <form class="mt-4 row" novalidate="">
        <h3>Manage Refund Management</h3>
        <div class="mb-3 form-group col-5">
          <label> By Customer Reason </label>
          <div class="controls">
            <input
              type="text"
              name="text"
      ...
      <div class="card card-body">
        ...
        <div class="table-responsive">
          <table class="table search-table align-middle text-nowrap">
            ...
            <tbody>
              <!-- start row -->
              <tr class="search-items" v-for="i in 5" :key="'user-' + i">
                <td>{{ i + 1 }}</td>
                <td>5245877455</td>
                <td>Booking Declined By Vendor</td>
                <td>Customer {{ i + 1 }}</td>
                <td>Nov 3, 2023</td>
                <td>78.75</td>
                <td>
                  <div class="action-btn">
                    ...
                    <a href="javascript:void(0)" class="text-dark ms-2">
...
export default {
  ...
  head() {
    return {
      ...
      script: [
        {
          src: "/assets/Modernize/js/apps/contact.js",
          body: true,
        },
        {
