          ...
          <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
            <div class="card-body">
              <div class="text-center">
                <img
                  src="/Modernize/images/svgs/icon-user-male.svg"
                  width="50"
                  height="50"
                  class="mb-3"
                  alt=""
        ...
        <div class="item">
          <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
            <div class="card-body">
              <div class="text-center">
                <img
                  src="/Modernize/images/svgs/icon-briefcase.svg"
                  width="50"
                  height="50"
                  class="mb-3"
                  alt=""
        ...
        <div class="item">
          <div class="card border-0 zoom-in bg-info-subtle shadow-none">
            <div class="card-body">
              <div class="text-center">
                <img
                  src="/Modernize/images/svgs/icon-mailbox.svg"
                  width="50"
                  height="50"
                  class="mb-3"
                  alt=""
        ...
        <div class="item">
          <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
            <div class="card-body">
              <div class="text-center">
                <img
                  src="/Modernize/images/svgs/icon-favorites.svg"
                  width="50"
                  height="50"
                  class="mb-3"
                  alt=""
        ...
        <div class="item">
          <div class="card border-0 zoom-in bg-info-subtle shadow-none">
            <div class="card-body">
              <div class="text-center">
                <img
                  src="/Modernize/images/svgs/icon-connect.svg"
                  width="50"
                  height="50"
                  class="mb-3"
                  alt=""
                ...
                <ul class="hstack mb-0">
                  <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                      <img
                        src="/Modernize/images/profile/user-2.jpg"
                  ...
                  <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                      <img
                        src="/Modernize/images/profile/user-3.jpg"
                        class="rounded-circle border border-2 border-white"
                        width="44"
                        height="44"
                        alt=""
                  ...
                  <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                      <img
                        src="/Modernize/images/profile/user-4.jpg"
                        class="rounded-circle border border-2 border-white"
                        width="44"
                        height="44"
                        alt=""
                  ...
                  <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                      <img
                        src="/Modernize/images/profile/user-5.jpg"
                        class="rounded-circle border border-2 border-white"
                        width="44"
                        height="44"
                        alt=""
