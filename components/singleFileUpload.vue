<template>
    <div>
      <div class="row">
        ...
        <div class="file-listing-file h-24" v-if="filePreview">
          <a class="previewFile h-24" target="_blank" :href="filePreview">
          ...
          <div class="remove-container-file">
            <i class="ti ti-trash fs-6 delete" @click="removeImage"></i>
          </div>
        </div>
      ...
      uploadFile(file) {
        ...
        axios
          ...
          .then((response) => {
            ...
            this.filePreview = response.data.response.msg;
